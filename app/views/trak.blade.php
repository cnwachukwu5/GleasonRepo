...
<fieldset>
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li><a href="#search" role="tab" data-toggle="tab">Trak Search Criteria</a></li>
    <li><a href="#options" role="tab" data-toggle="tab">Trak Options</a></li>
  </ul>
  ...
  <div class="tab-content">
    <div class="tab-pane active" id="customerinformation">
      ...
      <div class="form-group">
        <div class="col-sm-1">
          ...
          <a class="btn btn-primary btn-xs" data-toggle="modal" data-target="#modal" href="">Continue</a>
        </div>
      </div>
    ...
    <div class="tab-pane" id="package">
      ...
      <div>
        ...
        <br><br>
        <a class="btn btn-primary btn-xs" data-toggle="modal" data-target="#modal2" href="{{ url('/trak/cable/select') }}">Add CABLE</a>
        <a class="btn btn-primary btn-xs marginleft" data-toggle="modal" data-target="#modal2" href="{{ url('/trak/hose/select') }}">Add HOSE</a>
      </div>
    ...
    <div class="tab-pane" id="search">
      <div>
        ...
        <ul class="nav nav-tabs" role="tablist">
          <li class="active"><a href="#etrak" role="tab" data-toggle="tab">E-Trak</a></li>
          <li><a href="#gtrak" role="tab" data-toggle="tab">G-Trak</a></li>
          <li><a href="#grptrak" role="tab" data-toggle="tab">GRP Trak</a></li>
          <li><a href="#powertube" role="tab" data-toggle="tab">PowerTube</a></li>
        </ul>

        <div class="tab-content">
          <div class="tab-pane active" id="etrak">
              <br>
              <div class="row">
                <div class="col-sm-6 col-lg-3">
                  @if (isset($searchOptions))
                    @foreach ($searchOptions['etrak_models'] as $price)
                      <input type="checkbox" id="{{ $price }}" name="{{ $price }}"><label for="{{ $price }}">{{ $price }}</label>
                    @endforeach
                  @endif
            ...
            <!--
              ...
              <div class="row">
                <div class="col-sm-6 col-lg-3">
                  <input type="checkbox" id="etrak-models-none" name="etrak-models-none"><label for="etrak-models-none">None</label>
                  <input type="checkbox" id="etrak-models-none" name="etrak-models-none"><label for="etrak-models-none">None</label>
                  <input type="checkbox" id="etrak-models-none" name="etrak-models-none"><label for="etrak-models-none">None</label>
                  <input type="checkbox" id="etrak-models-none" name="etrak-models-none"><label for="etrak-models-none">None</label>
                  <input type="checkbox" id="etrak-models-none" name="etrak-models-none"><label for="etrak-models-none">None</label>
                ...
                <div class="col-sm-6 col-lg-3">
                  <input type="checkbox" id="etrak-models-any" name="etrak-models-any"><label for="etrak-models-any">Any</label>
                  <input type="checkbox" id="etrak-models-none" name="etrak-models-none"><label for="etrak-models-none">None</label>
          ...
          <div class="tab-pane" id="gtrak">2</div>
          <div class="tab-pane" id="grptrak">3</div>
          <div class="tab-pane" id="powertube">4</div>
        </div>
      </div>
    </div>
