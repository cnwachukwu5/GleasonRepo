<div class="container marginleft">
  <div class="col-lg-3">
    ...
    <div id='sm-checkboxes' class="marginleft">
      ...
      <div class="form-group">
        <div class="checkbox">
          <label><input type="checkbox" name="sm-checkboxes[]" value="sm21">SM21</label>
        </div>
      </div>
      <div class="form-group">
        <div class="checkbox">
          <label><input type="checkbox" name="sm-checkboxes[]" value="sm24">SM24</label>
        </div>
      </div>
      <div class="form-group">
        <div class="checkbox">
          <label><input type="checkbox" name="sm-checkboxes[]" value="sm28">SM28</label>
        </div>
      </div>
      <div class="form-group">
        <div class="checkbox">
          <label><input type="checkbox" name="sm-checkboxes[]" value="sm32">SM32</label>
        </div>
      </div>
    </div>
  </div>
  <div id='sm-inputs' class="col-lg-4">
    ...
    <div class="marginleft">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-3">
          <div class="input-group"><input type="text" name="sm-collectorcode" id="sm-collectorcode" class="form-control" value="212" />
          </div>
        </div>
      </div>
