<div class="container marginleft">
  <div class="col-lg-3">
    ...
    <div id='s-checkboxes' class="marginleft">
      ...
      <div class="form-group">
        <div class="checkbox">
          <label><input type="checkbox" name="k-checkboxes[]" value="16">K16</label>
        </div>
      </div>
      <div class="form-group">
        <div class="checkbox">
  ...
  <div id='s-inputs' class="col-lg-4">
    ...
    <div class="marginleft">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-3">
          <div class="input-group"><input type="text" name="k-collectorcode" class="form-control" value="4" />
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-3">
          <div class="input-group">
            <input type="text" name="k-pretensmax" class="form-control" value="6"/>
          </div>
        </div>
      </div>
    </div>
