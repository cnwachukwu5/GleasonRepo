  ...
  <div id='mmd-inputs' class="col-lg-4">
    ...
    <div class="marginleft">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-3">
          <div class="input-group"><input type="text" name="mmd-collectorcode" id="mmd-collectorcode" class="form-control" value="212" />
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-3">
          <div class="input-group">
            <input type="text" name="mmd-drummax" class="form-control" value="28" />
          </div>
        </div>
      </div>
