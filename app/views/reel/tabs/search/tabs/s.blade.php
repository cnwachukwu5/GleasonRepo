...
function setCollectorCode(collectCode){
    $('#s-collectorcode').val(collectCode);
    $('#mmd-collectorcode').val(collectCode);
    $('#sm-collectorcode').val(collectCode);
    $('#tmr-reels-code').val(collectCode);
    $('#u-collectorcode').val(collectCode);
    $('#sho-reels-code').val(collectCode);
    $('#p-collectorcode').val(collectCode);
