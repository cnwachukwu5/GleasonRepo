    ...
    <div id='u-inputs' class="col-lg-4">
        ...
        <div class="marginleft">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <div class="input-group"><input type="text" name="u-collectorcode" id="u-collectorcode" class="form-control" value="212" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="input-group">
                        <input type="text" name="u-drummin" class="form-control" value="8" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <div class="input-group">
                        <input type="text" name="u-drummax" class="form-control" value="28" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <select class="form-control" name="u-gearratio">
