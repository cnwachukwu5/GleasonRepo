...
<div id='tmr-checkboxes' class="marginleft" >
    ...
    <div class="form-group">
        <div class="checkbox">
            <input type="checkbox" name="tmr-checkboxes[]" value="none"><label for="tmr-reels-none">None</label>
        </div>
    </div>

    <div class="form-group">
        <div class="checkbox">
            <input type="checkbox" name="tmr-checkboxes[]" value="any"><label for="tmr-reels-any">Any</label>
        </div>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <div class="input-group"><input type="text" name="tmr-reels-code" id="tmr-reels-code" class="form-control" />
        </div>
    </div>
</div>
...
<script>
    ...
    $('#tmr-checkboxes :checkbox').change(function() {
        ...
        if(this.value == 'none' || this.value == 'any') {
            ...
            $('#tmr-checkboxes :checkbox').each(function() {
                if(value != this.value) {
            ...
            $("#tmr-checkboxes :checkbox[value='any']").attr('checked', false);
            $("#tmr-checkboxes :checkbox[value='none']").attr('checked', false);
