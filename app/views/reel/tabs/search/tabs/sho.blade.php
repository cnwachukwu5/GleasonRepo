...
<h3>
    ...
    <div id='sho-checkboxes' class="marginleft">
        <div class="form-group">
                <div class="checkbox">
                    <input type="checkbox" name="sho-checkboxes[]" value="none"><label for="sho-reels-none">None</label>
                </div>
        </div>

        <div class="form-group">
                <div class="checkbox">
                    <input type="checkbox" name="sho-checkboxes[]" value="any"><label for="sho-reels-any">Any</label>
                </div>
        </div>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
      <div class="input-group"><input type="text" name="sho-reels-code" id="sho-reels-code" class="form-control" /></div>
    </div>
</div>
...
<script>
    ...
    $('#sho-checkboxes :checkbox').change(function() {
        ...
        if(this.value == 'none' || this.value == 'any') {
            ...
            $('#sho-checkboxes :checkbox').each(function() {
                if(value != this.value) {
            ...
            $("#sho-checkboxes :checkbox[value='any']").attr('checked', false);
            $("#sho-checkboxes :checkbox[value='none']").attr('checked', false);
            ...
            if(highest == null) {
                drumMax.val('');
                    ...
                    //code coped from other scripts for other tabs, normally in this section there would be specific cases.
                    //This was done so that clear all / search all would affect sho and tmr
                    //they were originally defined as radio buttons
