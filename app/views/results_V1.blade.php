...
@section('content')
    <form method="post" action="{{url('/reel/printQuote')}}" id="frm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-sm-6">Number of Reels Required: <input type="number" id="numberOfReels" name="numberOfReels" min="0" max="100" step="1" value="0"></div>
                            <div class="col-sm-6">
                                Quote Prepared By: <input type="text" id="firstname" name="firstname" value="" maxlength="30">
                            </div>
                        </div>
                        <div class="row">
                            <br>
                            RE: <textarea id="quoteNotes" name="quoteNotes" rows="3" maxlength="255"></textarea>
                        </div>
                                        ...
                                        <div class="form-check">
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="showDiscount" type="checkbox" value="Yes">Show discount(s) on quote
                                                        </label>
                                                    </div>
                                                </li>
                                                <li class="list-group-item">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="showItemPrice" type="checkbox" value="Yes">Show itemized prices on quote
                                                        </label>
                                                    </div>
                                                </li>
                                                <li class="list-group-item">
                                                    <div class="form-check">
                                                        <label class="form-check-label" id="includeCableQuoteLabel">
                                                            <input class="form-check-input" id="includeCableQuote" type="checkbox" value="Yes">Include cable in quote
                                                        </label>
                                                    </div>
                                                ...
                                                <ul class="list-group" id="listItems">
                                                    <li class="list-group-item">
                                                        <div class="form-check">
                                                            <label class="form-check-label" id="includeCableInstallLabel">
                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="form-check-input" id="includeCableInstall" type="checkbox" value="Yes">Include cable installation
                                                            </label>
                                                        </div>
                                                    </li>
                                                </ul>
                                                <li class="list-group-item">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="showReelDesc" type="checkbox" value="Yes">Show Reel Description
                                                        </label>
                                                    </div>
                                            ...
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="includeDimDrwaings" type="checkbox" value="Yes">Include dimensional drawings
                                                        </label>
                                                    </div>
                                                </li>
                                            </ul>
                        ...
                        <div class="row" id="extraCable" style="margin-top:10px;margin-bottom:10px;">
                            <fieldset class="form-group discounts">
                                <span id="extraLable"><b>Extra Cable:</b></span> <span id="msg">(Note: cable for hookup and safety wrap(s) is already accounted for) </span>  <input type="number" id="extraCable" name="extraCable" min="0" max="1000" step="1" value="0"> feet
                            </fieldset>
                        </div>
        ...
        <input type="hidden" id="str_var" name="str_var" value="<?php print base64_encode(json_encode($data)) ?>">;
    </form>
...
@section('scripts')
    <script>
        ...
        //limit what can be typed into discount boxes
        $(".inputLimiter").on("keydown", function(){
            var e = event || window.event;  // get event object
            var key = e.keyCode || e.which; // get key cross-browser

            //limits user input to digits and allows for backspace ( 8 == backspace key event)
        ...
        //gives json object of data used in calcs
        $(document).ready(function () {
...
//                html += '<td>' + calcData3[0]['modelWgt'] + '</td>';
        ...
        //$(document).ready(function(){
            ...
            $('input:radio[name=rgmat]').change(function () {
                var rgappValue = $('input[name=rgmat]:checked').val();

                if(reelType === "S") {
                    if (frame === "32" && rgappValue === "Steel") {
        ...
        $(document).ready(function(){
           ...
           var quoteComplete = false; var quoteCableFlag = false;

           //Because this is for Reel application set cabSkip = true and cableSave = true (cableSave is a variable when a cable added to a package and saved to the DB
            cableSave = true; cabSkip = true; //When implementing or modules, these variables may change
            ...
            if(quoteComplete === false){
                ...
                switch (quoteCableFlag){
                    case false:
                        ...
                        break;
                    case true:
                        $("#includeCableQuote").val("Yes");
                        $('#includeCableInstall').val("Yes");
